      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center max-w-6xl">
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
          <img
            ...
            alt="hero"
            src="https://images.unsplash.com/photo-1630487656049-6db93a53a7e9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTA3fHx0ZWFtfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60"
          />
        </div>
